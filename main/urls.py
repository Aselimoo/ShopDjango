...
from .views import IndexView, AddProductView, ProductView, CategoryView, LogoutUserView,\
                    SignUpUserView, SignInUserView, UserProfileView, UserEditProfileView, SettingsView
